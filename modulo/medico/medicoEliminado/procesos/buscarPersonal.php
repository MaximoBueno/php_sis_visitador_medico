...
if(isset($_POST['valor'])){
    ...
    $agregado = "WHERE P.usu_crea = '$nro_unk' AND P.cod_tp_persona = 2 AND CONCAT(P.ap_paterno, ' ', P.ap_materno) LIKE CONCAT('%','$nro_documento','%')";
}else{
    require('./../../conexion/funciones.php');
    $nro_unk = $_SESSION['nro_doc_acc'];
    $agregado = "WHERE P.usu_crea = '$nro_unk' AND P.cod_tp_persona = 2";
}
