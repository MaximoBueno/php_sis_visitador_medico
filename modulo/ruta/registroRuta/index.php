...
<html lang="es">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-4 p-0">
                            <div class="col-lg-12 p-0">
                                <div class="card">
                                    <div class="card-header uGreen text-white py-1">Datos de Ruta</div>
                                    <div class="card-body p-1">
                                        <div class="input-group input-group-sm my-1">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">Centro de Salud</span>
                                            </div>
                                            <select name="centroSalud" id="centroSalud" class="form-control" disabled required>
                                        ...
                                        <div class="input-group input-group-sm my-1">
                                            ...
                                            <select name="medico" id="medico" class="form-control" disabled required>
                                                <option value="0">[NINGUNO]</option>
                                                <?php include("./procesos/getMedico.php"); ?>
                                            </select>
                                        </div>
                                        <div class="input-group input-group-sm my-1">
                                            <div class="input-group-prepend">
                        ...
                        <div class="col-lg-8 p-0">
                            <div class="card">
                                <div class="card-header uGreen text-white py-1">Buscar Ruta</div>
                                <div class="input-group input-group-sm p-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Buscar Ruta</span>
                                    </div>
                                    <input type="text" name="buscar" id="buscar" class="form-control" placeholder="Nombre dirección" onkeypress="buscarRuta(0);">
                                        ...
                                        <table class="table table-sm table-hover table-bordered" style="font-size:12px;">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th style="width:120px;" class="text-center" >Centro Salud</th>
                                                    <th style="width:70px;" class="text-center">Distrito</th>
                                                    <th style="width:120px;" class="text-center">Médico</th>
                                                    <th style="width:150px;" class="text-center">Dirección</th>
                                                </tr>
                                            </thead>

                                            <tbody id="contenidoIngreso">
                                                <?php include("./procesos/buscarRuta.php"); ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
        ...
        <script src="./procesos/registroRuta.js"></script>
    </body>
</html>