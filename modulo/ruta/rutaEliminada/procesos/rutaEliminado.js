...
function deshabilitarRuta(r){
    $.post("./procesos/estadoRuta.php", {valor: r, ind: 0}, function(mensaje) {
        if(mensaje == "OK"){
            modalOKI(2);
            buscarRuta(1);
        }else if(mensaje == "NUL"){
...
function habilitarRuta(r){
    $.post("./procesos/estadoRuta.php", {valor: r, ind: 1}, function(mensaje) {
        if(mensaje == "OK"){
            modalOKI(3);
            buscarRuta(1);
        }else if(mensaje == "NUL"){
