...
<html lang="es">
    ...
    <body>
        ...
        <div class="bg-socendary" id="uMdi">
            ...
            <div class="uMain-lg border-left border-warning" id="uMain">
                <div id="my_titulo" class="form-control form-control-sm text-center uGreen py-1">
                    <span>Linea de Producto Eliminado</span>
                </div>
                <div class="container-fluid p-1">
                    <div class="card">
                        <div class="card-header uGreen text-white py-1">Buscar Linea de Producto</div>
                                ...
                                <table class="table table-sm table-hover table-bordered" style="font-size:12px;">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th style="width:150px;" class="text-center">Linea de Producto</th>
        ...
        <script src="./procesos/lineaProductoEliminado.js"></script>
    </body>
</html>