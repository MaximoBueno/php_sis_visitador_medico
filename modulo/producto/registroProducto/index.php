...
<html lang="es">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-4 p-0">
                            <div class="col-lg-12 p-0">
                                <div class="card">
                                    <div class="card-header uGreen text-white py-1">Datos Producto</div>
                                    <div class="card-body p-1">
                                        <div class="input-group input-group-sm my-1">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">Producto</span>
                                            </div>
                                            <input type="text" name="producto" id="producto" class="form-control" disabled required>
                                        </div>
                                        <div class="input-group input-group-sm my-1">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">Descripción</span>
                                            </div>
                                            <input type="text" name="descripcion" id="descripcion" class="form-control" disabled required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 p-0">
                            <div class="card">
                                <div class="card-header uGreen text-white py-1">Buscar Producto</div>
                                <div class="input-group input-group-sm p-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Buscar Producto</span>
                                    </div>
                                    <input type="text" name="buscar" id="buscar" class="form-control" placeholder="Nombre Producto" onkeypress="buscarProducto(0);">
                                    ...
                                    <div class="col-lg-12 p-0 table-responsive" style="height:400px;">
                                        <table class="table table-sm table-hover table-bordered" style="font-size:12px;">
                                            ...
                                            <tbody id="contenidoIngreso">
                                                <?php include("./procesos/buscarProducto.php"); ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
        ...
        <script src="./procesos/registroProducto.js"></script>
    </body>
</html>