...
$consulta = "SELECT cod_linea_producto, 
linea_producto, 
descripcion 
FROM linea_producto
WHERE estado = 1;";
...
//Renombrar Hoja
$objPHPExcel->getActiveSheet()->setTitle('Reporte de Linea de Producto');
...
header('Content-Disposition: attachment;filename="reporteLProducto.xlsx"');
