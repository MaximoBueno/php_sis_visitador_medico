...
<html lang="es">
    ...
    <body>
                                ...
                                <table class="table table-sm table-hover table-bordered" style="font-size:12px;">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th style="width:150px;" class="text-center">Producto</th>
                                            <th style="width:150px;" class="text-center">Descripción</th>
        ...
        <script src="./procesos/productoEliminado.js"></script>
    </body>
</html>