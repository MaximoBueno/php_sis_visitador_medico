...
JOIN genero AS G
ON P.cod_genero = G.cod_genero WHERE P.estado = 1;";
...
$objPHPExcel->getActiveSheet()->getStyle('J1:J'.$myFilas)->applyFromArray($styleArrayBorder);

//Set Color de fondo
$objPHPExcel->getActiveSheet()->getStyle('A1:J1')->getFill()->applyFromArray($styleArrayBgm);
...
header('Content-Disposition: attachment;filename="reportePersonal.xlsx"');
