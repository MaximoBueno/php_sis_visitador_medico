...
function controlAdd(isNot){
    ...
    $("#tipo_persona").prop("disabled", isNot);
...
function registrarPersonal(){
    ...
    datosRegistro[6] = $("#tipo_persona").val();
    datosRegistro[7] = $("#fecha_nacimiento").val();
    datosRegistro[8] = $("#direccion").val();
...
function obtenerRegistro(r){
    ...
    var fila9 =r.cells[10].innerText;
    ...
    document.getElementById("fecha_nacimiento").value = fila8;
    document.getElementById("direccion").value = fila9;
    
    selectComboByText("tipo_documento", fila4);
    selectComboByText("genero", fila6);
    selectComboByText("tipo_persona", fila7);
