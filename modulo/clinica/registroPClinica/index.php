...
<html lang="es">
    ...
    <body>
        ...
        <div class="bg-socendary" id="uMdi">
            ...
            <div class="uMain-lg border-left border-warning" id="uMain">
                <div id="my_titulo" class="form-control form-control-sm text-center uGreen py-1">
                    <span>Registro de Producto - Clinica</span>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 p-0">
                            <div class="col-lg-12 p-0">
                                <div class="card">
                                    <div class="card-header uGreen text-white py-1">Datos de Producto - Clinica</div>
                                    <div class="card-body p-1">
                                        <div class="input-group input-group-sm my-1">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text bg-info text-white">Fecha de Horario</span>
                                            </div>
                                        ...
                                        <div class="input-group input-group-sm my-1">
                                            ...
                                            <select name="producto" id="producto" class="form-control" disabled required>
                                        ...
                                        <div class="input-group input-group-sm my-1">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">Clinica</span>
                                            </div>
                                            <select name="clinica" id="clinica" class="form-control" disabled required>
                                                <option value="0">[NINGUNO]</option>
                        ...
                        <div class="col-lg-8 p-0">
                            <div class="card">
                                <div class="card-header uGreen text-white py-1">Buscar Producto - Clinica</div>
                                <div class="input-group input-group-sm p-2">
                                    <div class="input-group input-group-sm my-1">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-info text-white">Buscar Por Fecha</span>
                                        </div>
                                        <input class="form-control"
                                               type="date"
                                               name="bFechaHorario"
                                        ...
                                        <button type="button" class="btn btn-info btn-group btn-sm" onclick="buscarPClinica(4);">
                                        ...
                                        <table class="table table-sm table-hover table-bordered" style="font-size:12px;">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th style="width:120px;" class="text-center" >Fecha Horario</th>
                                                    <th style="width:70px;" class="text-center">Producto</th>
                                                    <th style="width:120px;" class="text-center">Clinica</th>
                                                    <th style="width:150px;" class="text-center">Dirección</th>
                                                </tr>
                                            </thead>

                                            <tbody id="contenidoIngreso">
                                                <?php include("./procesos/buscarPClinica.php"); ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
        ...
        <script src="./procesos/registroPClinica.js"></script>
    </body>
</html>