...
$consulta = "SELECT H.cod_horario, H.fecha, H.dia, 
H.hora, D.distrito,
CS.centro_salud,
CONCAT(P.ap_paterno, ' ', P.ap_materno, ', ', P.nombres) AS 'Nombres', 
R.direccion,
PO.producto,
CONCAT(H.hecho, '-', H.cod_horario) AS 'A'
FROM horario AS H
JOIN distrito AS D 
...
//IMPRIMIMOS LA MATRIZ POR BLOQUES, ES DECIR BLOQUE LUNES, MARTES, ETC, SABIENDO QUE SON 12 MAXIMO POR BLOQUE
//AQUI VA EL FILTRO DE AM/PM
$my_cont = 0;
for($i = 0; $i < 6 - 1; $i++){
    if($i == 0){
